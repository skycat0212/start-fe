...
var pageSize = 3;
var totalPageSize = calTotalPage();
console.log(totalPageSize)

var nowPage = 1;

function calTotalPage(){
    var val = parseInt(todayPhoto.length / pageSize);
    if (todayPhoto.length % pageSize !== 0) { val += 1 }
    return val
}

totalPage.innerText = totalPageSize;
pageNo.innerText = nowPage;
...
function setImage(){
    var str = '';
    for(var i=(nowPage-1)*3; i<nowPage*3; i++){
